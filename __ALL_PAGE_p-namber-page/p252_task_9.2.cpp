...
//Перевод числа в тригонометрическую форму.
...
complex1 chislo1, chislo2;
complex1 chislo5;
complex2 chislo3, chislo4;
float ro1 , fi1 ;
chislo1=vvod1 ( ) ;
...
//в тригонометрическую форму и вывод их на экран. 
cout<<"Сумма чисел " ;
...
chislo5=pow1(chislo1 ,5,true); //Возведениечиславпятуюстепень. 
sqrtn1(chislo1 , 5, &ro1, &fi1 , true); 
//Извлечениекорняпятойстепени.
